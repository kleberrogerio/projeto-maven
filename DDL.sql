...
pro_nome_usuario_uk unique (pro_nome_usuario));
...
constraint tra_pro_fk foreign key (pro_avaliador_id)references pro_professor (pro_id));
create table ent_entrega (
	alu_id bigint unsigned,
	tra_id bigint unsigned,primary key (alu_id, tra_id),
